...
- Application-Code - folder containing the code of the application
- QScripts - folder containing example of QScripts
- Example-run - folder containing the input and resulting output after running the application
- ShellPlugin.jar - runnable jar
